# Closed retail POs pulled DIRECTLY from mcp_read.purchase_orders.
...
# Pulled 30 Aug 2026. (brand, channel, ym, received_sar)
PO_CLOSED=[
...
("Marah","Amazon Retail","2026-08",4650.60),
